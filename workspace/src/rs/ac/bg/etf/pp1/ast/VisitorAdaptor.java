...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(AFactorDesignator AFactorDesignator) { visit(); }
    ...
    public void visit(ReadADesign ReadADesign) { visit(); }
    public void visit(ReadSDesign ReadSDesign) { visit(); }
    ...
    public void visit(NamespName NamespName) { visit(); }
    public void visit(NamespDecl NamespDecl) { visit(); }
