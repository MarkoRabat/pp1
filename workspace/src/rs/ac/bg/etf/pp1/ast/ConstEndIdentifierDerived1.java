...
public class ConstEndIdentifierDerived1 extends ConstEndIdentifier {

    private String I1;
    private Initializator Initializator;

    public ConstEndIdentifierDerived1 (String I1, Initializator Initializator) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstEndIdentifierDerived1(\n");
